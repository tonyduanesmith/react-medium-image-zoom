...
var ImageZoom = (function(_Component) {
  ...
  function ImageZoom(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (ImageZoom.__proto__ || Object.getPrototypeOf(ImageZoom)).call(
        this,
        props
      )
    )
     ...
     */
      },
      {
        ...
        value: function componentDidUpdate(prevProps, prevState) {
          var prevIsZoomed = isControlled(prevProps.isZoomed)
            ? prevProps.isZoomed
            : prevState.isZoomed
          var isZoomed = isControlled(this.props.isZoomed)
            ? this.props.isZoomed
            : this.state.isZoomed
      ...
      },
      {
         ...
         */
          ...
          var attrs = _extends(
            ...
            image,
            { src: src, style: this._getImageStyle() },
            !isMaxDimension && {
              ...
              _react2.default.createElement(
                ...
                this.state.imageError &&
                  _react2.default.createElement(_BrokenImage2.default, {
                    style: { width: 48, height: 48, color: _grey2.default[300] }
                  })
              )
            ),
            this.image && (isZoomed || this.isClosing)
              ? _react2.default.createElement(
                  ...
                  _react2.default.createElement(_Zoom2.default, {
                    ...
                    image: this.image,
                    shouldRespectMaxDimension: this.props
        ...
        value: function _checkShouldDisableComponent() {
          this.setState({
            isMaxDimension:
              ...
              (0, _helpers.isMaxDimension)(this.image)
          })
        }
      },
      {
        ...
        value: function _getImageStyle() {
          ...
          return _extends(
            {},
            _defaults2.default.styles.image,
            style,
        ...
        value: function _handleUnzoom(src, allowRefocus) {
          ...
          return function() {
            var changes = _extends(
              { isZoomed: false },
              _this3.props.shouldReplaceImage && { src: src }
            )
