    ...
    [
        ...
        value: function render() {
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'img',
              _extends({}, zoomImage, { src: src, style: style })
            ),
            _react2.default.createElement(
              TmpImg,
              _extends({}, zoomImage, { src: tmpSrc, style: style })
            )
          )
        }
      },
      ...
      },
      {
        ...
        value: function _getZoomContainerStyle() {
          return _extends(
            {},
            _defaults2.default.styles.zoomContainer,
      ...
      },
      {
        ...
        value: function _getZoomImageStyle() {
          ...
          if (!this.state.hasLoaded || !this.state.isZoomed) {
            return _extends(
              {},
              _defaults2.default.styles.zoomImage,
          ...
          var scale =
            shouldRespectMaxDimension && !src
              ? (0, _helpers.getMaxDimensionScale)({
                  width: width,
                  height: height,
...
var TmpImg = function TmpImg(_ref) {
  ...
  return src
    ? _react2.default.createElement(
        'img',
        _extends({}, props, { src: src, style: getTmpStyle(style) })
      )
    : null
}
